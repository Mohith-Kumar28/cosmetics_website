    ...
    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Real-Time Augmented Reality</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Deep Learning-Powered Accuracy</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Self-Supervised Learning</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Trainable Imitator Module</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Innovative Applications</span>
        </div>
      </div>
