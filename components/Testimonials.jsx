...
<div className="relative overflow-hidden ">
  ...
  <div className="container px-5 py-14 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p className="leading-relaxed text-lg">I was amazed at how realistic and accurate Mystic Beauty's virtual try-on experience is. The attention to detail in the rendering is outstanding. Now I can confidently showcase different makeup looks and inspire my followers with ease. Mystic Beauty is a game-changer!</p>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p className="leading-relaxed text-lg">As a tech enthusiast, I appreciate Mystic Beauty's innovative use of augmented reality. The seamless integration of their technology with the online shopping experience is impressive. It's a great blend of cutting-edge technology and the beauty industry. Kudos to the Mystic Beauty team!</p>
      <span className="inline-block h-1 w-10 rounded bg-red-500 mt-8 mb-6"></span>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p className="leading-relaxed text-lg">Mystic Beauty has made my beauty routine so much more efficient. Instead of spending hours trying on different makeup products in-store, I can now use their virtual try-on feature to find the perfect match. It's a time-saver and ensures I always look my best, even with a busy schedule.</p>
      <span className="inline-block h-1 w-10 rounded bg-red-500 mt-8 mb-6"></span>
